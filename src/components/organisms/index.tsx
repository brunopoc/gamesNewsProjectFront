...
export { default as RegisterCardComponent } from './RegisterCard/RegisterCardComponent';
...
export { default as AppBarAdminComponent } from './AppBarAdmin/AppBarAdminComponent';
